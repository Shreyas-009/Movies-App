...
const VerticalCards = ({ data, title }) => {
  return (
    <div className="grid grid-cols-2  gap-1 md:flex md:flex-wrap w-full md:gap-12 justify-center py-5 md:py-10">
      {data.map((c, i) => (
        <Link
        ...
        >
          ...
          {c.vote_average && (
            <div className=" absolute right-[1%] md:right-[-10%] bottom-[85%] md:bottom-[30%] rounded-full text-xl font-semibold bg-yellow-600 h-[6vh] w-[6vh] flex justify-center items-center">
